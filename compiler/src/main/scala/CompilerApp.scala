...
import me.gabriel.seren.analyzer.inference.DefaultTypeInference
...
object CompilerApp extends App {
  ...
  typeInference.traverseBottomUp(typeEnvironment.root, root)
  typeEnvironment.root.prettyPrintLazyTypes()
