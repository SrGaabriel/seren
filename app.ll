...
@str_-510303637=linkonce_odr unnamed_addr constant [6 x i8] c"Earth\00"
@str_2023089684=linkonce_odr unnamed_addr constant [7 x i8] c"X: %d
\00"
@str_858531224=linkonce_odr unnamed_addr constant [7 x i8] c"Y: %d
\00"
@str_-571693059=linkonce_odr unnamed_addr constant [7 x i8] c"Z: %d
\00"
@str_1880171135=linkonce_odr unnamed_addr constant [7 x i8] c"W: %d
\00"
@str_1732229841=linkonce_odr unnamed_addr constant [7 x i8] c"A: %d
\00"
@str_847631003=linkonce_odr unnamed_addr constant [7 x i8] c"B: %d
\00"
@str_1648615730=linkonce_odr unnamed_addr constant [7 x i8] c"L: %d
\00"
@str_-1913962101=linkonce_odr unnamed_addr constant [12 x i8] c"Planet: %s
\00"
declare void @printf(i8*, ...)

define i32 @main() {
  %reg_1 = alloca %Vector, align 1
  %reg_3 = bitcast [6 x i8]* @str_-510303637 to i8*
...
define void @print_vector(%Vector* %reg_1) {
  ...
  %reg_16 = bitcast [7 x i8]* @str_-571693059 to i8*
  ...
  %reg_23 = bitcast [7 x i8]* @str_1880171135 to i8*
  ...
  %reg_30 = bitcast [7 x i8]* @str_1732229841 to i8*
  ...
  %reg_37 = bitcast [7 x i8]* @str_847631003 to i8*
  ...
  %reg_44 = bitcast [7 x i8]* @str_1648615730 to i8*
  ...
  %reg_51 = bitcast [12 x i8]* @str_-1913962101 to i8*
