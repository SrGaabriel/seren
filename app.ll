...
@str_1240191965 =linkonce_odr unnamed_addr constant [6 x i8] c"Earth\00"
@str_356112852 =linkonce_odr unnamed_addr constant [7 x i8] c"X: %d
\00"
@str_1515202099 =linkonce_odr unnamed_addr constant [7 x i8] c"Y: %d
\00"
@str_1885192112 =linkonce_odr unnamed_addr constant [7 x i8] c"Z: %d
\00"
@str_-1712322058 =linkonce_odr unnamed_addr constant [7 x i8] c"W: %d
\00"
@str_1449267514 =linkonce_odr unnamed_addr constant [7 x i8] c"A: %d
\00"
@str_1572764343 =linkonce_odr unnamed_addr constant [7 x i8] c"B: %d
\00"
@str_564836240 =linkonce_odr unnamed_addr constant [7 x i8] c"L: %d
\00"
@str_-1099519966 =linkonce_odr unnamed_addr constant [12 x i8] c"Planet: %s
\00"
declare void @printf(i8*, ...)

define i32 @main() {
  %reg_1 = alloca %Vector, align 1
  %reg_3 = bitcast [6 x i8]* @str_1240191965 to i8*
...
define void @print_vector(%Vector* %reg_1) {
  ...
  %reg_16 = bitcast [7 x i8]* @str_1885192112 to i8*
  ...
  %reg_23 = bitcast [7 x i8]* @str_-1712322058 to i8*
  ...
  %reg_30 = bitcast [7 x i8]* @str_1449267514 to i8*
  ...
  %reg_37 = bitcast [7 x i8]* @str_1572764343 to i8*
  ...
  %reg_44 = bitcast [7 x i8]* @str_564836240 to i8*
  ...
  %reg_51 = bitcast [12 x i8]* @str_-1099519966 to i8*
