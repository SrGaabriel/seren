...
@str_118819429=linkonce_odr unnamed_addr constant [6 x i8] c"Earth\00"
@str_-1372047936=linkonce_odr unnamed_addr constant [26 x i8] c"20+20 does not equal %d!
\00"
@str_331481546=linkonce_odr unnamed_addr constant [25 x i8] c"20+20 indeed equals %d!
\00"
@str_-1635495558=linkonce_odr unnamed_addr constant [7 x i8] c"X: %d
\00"
@str_1535967197=linkonce_odr unnamed_addr constant [7 x i8] c"Y: %d
\00"
@str_362826051=linkonce_odr unnamed_addr constant [7 x i8] c"Z: %d
\00"
@str_-1626521907=linkonce_odr unnamed_addr constant [7 x i8] c"W: %d
\00"
@str_-281508766=linkonce_odr unnamed_addr constant [7 x i8] c"A: %d
\00"
@str_-1166666968=linkonce_odr unnamed_addr constant [7 x i8] c"B: %d
\00"
@str_1627515043=linkonce_odr unnamed_addr constant [7 x i8] c"L: %d
\00"
@str_-319153828=linkonce_odr unnamed_addr constant [12 x i8] c"Planet: %s
\00"
...
entry:
  ...
  %reg_3 = bitcast [6 x i8]* @str_118819429 to i8*
...
block_0:
  %reg_40 = bitcast [25 x i8]* @str_331481546 to i8*
  call void @printf(i8* %reg_40, i32 %reg_29)
  ret i32 0
  br label %block_2
block_1:
  %reg_36 = bitcast [26 x i8]* @str_-1372047936 to i8*
...
entry:
  ...
  %reg_16 = bitcast [7 x i8]* @str_362826051 to i8*
  ...
  %reg_23 = bitcast [7 x i8]* @str_-1626521907 to i8*
  ...
  %reg_30 = bitcast [7 x i8]* @str_-281508766 to i8*
  ...
  %reg_37 = bitcast [7 x i8]* @str_-1166666968 to i8*
  ...
  %reg_44 = bitcast [7 x i8]* @str_1627515043 to i8*
  ...
  %reg_51 = bitcast [12 x i8]* @str_-319153828 to i8*
