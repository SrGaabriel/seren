...
@str_-253165689 =linkonce_odr unnamed_addr constant [6 x i8] c"Earth\00"
@str_-487402727 =linkonce_odr unnamed_addr constant [7 x i8] c"X: %d
\00"
@str_-489875019 =linkonce_odr unnamed_addr constant [7 x i8] c"Y: %d
\00"
@str_1562496355 =linkonce_odr unnamed_addr constant [7 x i8] c"Z: %d
\00"
@str_1417326194 =linkonce_odr unnamed_addr constant [7 x i8] c"W: %d
\00"
@str_-387110561 =linkonce_odr unnamed_addr constant [7 x i8] c"A: %d
\00"
@str_-1868277111 =linkonce_odr unnamed_addr constant [7 x i8] c"B: %d
\00"
@str_412156863 =linkonce_odr unnamed_addr constant [7 x i8] c"L: %d
\00"
@str_538422070 =linkonce_odr unnamed_addr constant [12 x i8] c"Planet: %s
\00"
declare void @printf(i8*, ...)

define i32 @main() {
  %reg_1 = alloca %Vector, align 1
  %reg_3 = bitcast [6 x i8]* @str_-253165689 to i8*
...
define void @print_vector(%Vector* %reg_1) {
  ...
  %reg_16 = bitcast [7 x i8]* @str_1562496355 to i8*
  ...
  %reg_23 = bitcast [7 x i8]* @str_1417326194 to i8*
  ...
  %reg_30 = bitcast [7 x i8]* @str_-387110561 to i8*
  ...
  %reg_37 = bitcast [7 x i8]* @str_-1868277111 to i8*
  ...
  %reg_44 = bitcast [7 x i8]* @str_412156863 to i8*
  ...
  %reg_51 = bitcast [12 x i8]* @str_538422070 to i8*
